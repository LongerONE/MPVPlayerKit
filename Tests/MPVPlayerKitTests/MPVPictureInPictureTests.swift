...
final class MPVPictureInPictureTests: XCTestCase {
    ...
    func testPictureInPictureRendererInvariantSnapshotProtectsEDRLayerAndProfiles() {
        ...
        XCTAssertNil(sharedOptions["tone-mapping"])
        ...
        XCTAssertEqual(dolbyVisionOptions["tone-mapping-param"], "0.22")
        XCTAssertEqual(dolbyVisionOptions["hdr-compute-peak"], "yes")
        XCTAssertEqual(dolbyVisionOptions["target-peak"], "450")
        XCTAssertEqual(dolbyVisionOptions["target-contrast"], "inf")
